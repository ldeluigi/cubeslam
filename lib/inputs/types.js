...
function execute(world,input){
  ...
  switch(input[0]){
    case exports.MOVE:  return require('../actions/index').movePaddle(world,input[1],input[2])
    case exports.DIED:  return require('../actions/index').roundOver(world,input[1],input[2])
